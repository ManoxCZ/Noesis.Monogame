...
namespace Noesis.MonoGame.Generated
{
    ...
    public struct NoesisVertexPosColorTex0RectImagePos : Microsoft.Xna.Framework.Graphics.IVertexType
    {
		...
		public Microsoft.Xna.Framework.Vector4 ImagePos;
        ...
        static NoesisVertexPosColorTex0RectImagePos()
		{
            ...
            { 
				...
				new (28, Microsoft.Xna.Framework.Graphics.VertexElementFormat.Vector4, Microsoft.Xna.Framework.Graphics.VertexElementUsage.Normal, 1),

            };			
			_vertexDeclaration = new Microsoft.Xna.Framework.Graphics.VertexDeclaration(elements);

            Debug.Assert(_vertexDeclaration.VertexStride == Marshal.SizeOf<NoesisVertexPosColorTex0RectImagePos>());
		}
    }
}
