...
namespace Noesis.MonoGame.Generated
{
    ...
    public struct NoesisVertexPosTex0Tex1RectTile : Microsoft.Xna.Framework.Graphics.IVertexType
    {
        ...
        static NoesisVertexPosTex0Tex1RectTile()
		{
            ...
            { 
				...
				new (24, Microsoft.Xna.Framework.Graphics.VertexElementFormat.NormalizedShort4, Microsoft.Xna.Framework.Graphics.VertexElementUsage.Binormal, 0),
				new (32, Microsoft.Xna.Framework.Graphics.VertexElementFormat.Vector4, Microsoft.Xna.Framework.Graphics.VertexElementUsage.Tangent, 0),

            };			
			_vertexDeclaration = new Microsoft.Xna.Framework.Graphics.VertexDeclaration(elements);

            Debug.Assert(_vertexDeclaration.VertexStride == Marshal.SizeOf<NoesisVertexPosTex0Tex1RectTile>());
		}
    }
}
