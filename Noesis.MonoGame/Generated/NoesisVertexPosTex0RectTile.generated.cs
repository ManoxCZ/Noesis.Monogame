...
namespace Noesis.MonoGame.Generated
{
    ...
    public struct NoesisVertexPosTex0RectTile : Microsoft.Xna.Framework.Graphics.IVertexType
    {
        ...
        static NoesisVertexPosTex0RectTile()
		{
            ...
            { 
				...
				new (16, Microsoft.Xna.Framework.Graphics.VertexElementFormat.NormalizedShort4, Microsoft.Xna.Framework.Graphics.VertexElementUsage.Binormal, 0),
				new (24, Microsoft.Xna.Framework.Graphics.VertexElementFormat.Vector4, Microsoft.Xna.Framework.Graphics.VertexElementUsage.Tangent, 0),

            };			
			_vertexDeclaration = new Microsoft.Xna.Framework.Graphics.VertexDeclaration(elements);

            Debug.Assert(_vertexDeclaration.VertexStride == Marshal.SizeOf<NoesisVertexPosTex0RectTile>());
		}
    }
}
