...
namespace Noesis.MonoGame.Generated
{
    ...
    public struct NoesisVertexPosColorCoverage : Microsoft.Xna.Framework.Graphics.IVertexType
    {
        ...
        static NoesisVertexPosColorCoverage()
		{
            ...
            { 
				...
				new (12, Microsoft.Xna.Framework.Graphics.VertexElementFormat.Single, Microsoft.Xna.Framework.Graphics.VertexElementUsage.Normal, 0),

            };			
			_vertexDeclaration = new Microsoft.Xna.Framework.Graphics.VertexDeclaration(elements);

            Debug.Assert(_vertexDeclaration.VertexStride == Marshal.SizeOf<NoesisVertexPosColorCoverage>());
		}
    }
}
